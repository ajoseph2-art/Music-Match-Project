...
SECRET_KEY = os.environ.get('SECRET_KEY', "django-insecure-6-anwj3idxr)!sjg06qg(=yky=a0+7w3j(d#!6y^_thwa12g@m")
...
# CSRF Trusted Origins - Load Balancer IP
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", "musicmatch"),
